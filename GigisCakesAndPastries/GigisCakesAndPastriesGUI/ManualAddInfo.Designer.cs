namespace GigisCakesAndPastriesGUI
{
    partial class ManualAddInfo
    {
        ...
        private TextBox mnlAddressBox;
        private Label mnlFullAddLabel;
        private TextBox mnlPhoneNumberBox;
        private Label mnlPhoneNumberLabel;
        private TextBox mnlEmailBox;
        private Label mnlEmailLabel;
        private Label mnlLastNameLabel;
        private Label mnlMiddleNameLabel;
        private Label mnlFirstNameLabel;
        private TextBox mnlLastNameBox;
        private TextBox mnlMiddleNameBox;
        private TextBox mnlFirstNameBox;
